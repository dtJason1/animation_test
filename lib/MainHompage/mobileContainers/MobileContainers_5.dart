...
class MobileContainer_5 extends StatefulWidget{
  @override
  State<MobileContainer_5> createState() => _MobileContainer_5State();
}

class _MobileContainer_5State extends State<MobileContainer_5> with TickerProviderStateMixin {
