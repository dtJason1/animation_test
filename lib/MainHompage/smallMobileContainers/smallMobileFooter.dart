...
class SmallMobileFooter extends StatefulWidget{
  @override
  State<SmallMobileFooter> createState() => _SmallMobileFooterState();
}

class _SmallMobileFooterState extends State<SmallMobileFooter> with TickerProviderStateMixin {
      ...
      child: Padding(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Container(
                  constraints: BoxConstraints(maxWidth: (MediaQuery.of(context).size.width - rem(1)*2)/8*4),
                ...
                children: [
                  Container(
                    ...
                    child: Column(
                      ...
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text("@2024", softWrap: true, style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),),
                        Container(height: rem(1),),

                        Text("Licenses", softWrap: true,style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),),
                        Container(height: rem(1),),


                        Text("Style guide", softWrap: true,style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),),
                        Container(height: rem(1),),
                        Text("Back to top", softWrap: true, style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),),
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Changelog", softWrap: true,style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),),
                      Container(height: rem(1.5),),
                      Text("Webflow", softWrap: true,style:  TextStyle(color: Color.fromRGBO(255, 255, 255 ,0.5), fontSize: rem(1)),)
