...
class _SmallMobileContainer_4State extends State<SmallMobileContainer_4> with TickerProviderStateMixin {
              ...
              Column(
                ...
                children: [
                  ...
                  Container(constraints: BoxConstraints(maxWidth: MediaQuery.of(context).size.width,),
                    child: Text("Our work lie in effectively implementing strategic plans to generate tangible business value",style: TextStyle(fontWeight: FontWeight.w500, fontSize: rem(1.5), ),)
                    ,
                  )
                ],
              ),
                ...
                children: [
                  ...
                  ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text("View All Projects" ,style:  TextStyle(color: Colors.black, fontSize: rem(1)),),
